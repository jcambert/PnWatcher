...
{
    public class ObservableFileSystemWatcher : IObservableFileSystemWatcher, IInitializable
    {
        ...
        public event EventHandler<ObservableFileSystemWatcherEventArgs> onStatusChanged;
        ...
        public void Start()
        {
            ...
            onStatusChanged(this, new ObservableFileSystemWatcherEventArgs(this, true));
        }

        public void Stop()
        {
            Watcher.EnableRaisingEvents = false;
            onStatusChanged(this, new ObservableFileSystemWatcherEventArgs(this, false));
        }
        ...
        public void Initialize()
        {
            ...
            StatusChanged=Observable.FromEventPattern<ObservableFileSystemWatcherEventArgs>(
                    evt => this.onStatusChanged += evt,
                    evt => this.onStatusChanged -= evt
